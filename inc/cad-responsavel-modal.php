...
<div class="modal fade" id="modalResponsavelLegal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="" method="post" id="formModalResponsavelLegal">
                <div class="modal-header">
                    <h4 class="title" id="modalResponsavelLegalLabel">Adicionar participantes</h4>
                </div>
...
$(document).ready(function() {
    ...
    $('#modalResponsavelLegal').on('hidden.bs.modal', function (e) {
        $('#modalResponsavelLegal form').trigger('reset');
     })
...
$('#formModalResponsavelLegal').on('submit', async function(event) {
                ...
                if (idprevenda) {
                    encryptRSA(idprevenda, publicKeyPEM).then(encryptedId => {
                        $('.bloco-vinculados').load('./blocos/lista-vinculados.php', { i: encryptedId }, function() {
                            $('#modalResponsavelLegal').modal('hide');
                        });
                    }).catch(err => {
