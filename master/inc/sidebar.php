<aside id="minileftbar" class="minileftbar">
    <ul class="menu_list">
        <li>
            ...
            <a class="navbar-brand" href="index.php"><img src="assets/images/logo.svg" alt="Alpino"></a>
        </li>
        ...
        <div class="slim_scroll">
            <div class="card tasks">
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        <span class="text-muted">Park Shopping Canoas <span class="float-right">29%</span></span>
                        <div class="progress">
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        <span class="text-muted">Shopping Guararapes <span class="float-right">78%</span></span>
                        <div class="progress">
                ...
                <div class="body">
                    <a href="javascript:void(0);">
                        <span class="text-muted">Shopping Metropolitano <span class="float-right">68%</span></span>
                        <div class="progress">
    ...
    <div id="leftsidebar" class="sidebar">
        <div class="menu">
            <ul class="list">
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-grid"></i><span>Relatórios</span> <span class="badge badge-info float-right">6</span></a>
                    <ul class="ml-menu">                        
                ...
                <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-chart"></i><span>Faturas</span> <span class="badge badge-default float-right">6</span></a>
                    <ul class="ml-menu">
