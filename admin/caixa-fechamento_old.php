...
function calcularValores() {
    ...
    const valorEntradas = formatToDecimal(dinheiro) + formatToDecimal(valAberturaCaixa);
    const valorSaidas = formatToDecimal(despesas) + formatToDecimal(depositos)
    const valorTotal = valorEntradas - valorSaidas;

    const valorFinal = valorTotal + (valorExtra);
