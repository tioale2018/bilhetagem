    ...
    <ul class="nav navbar-nav">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="./img/logo-multi2.png" alt="" width="150"></a>
            </div>
        </li>
       ...
       <!--  <li class="search_bar">
        ...
        <li class="float-right">
            ...
            <div class="d-inline mr-3"><span><b>Evento:</b> <?= $_SESSION['evento_titulo'] ?></span></div> 
