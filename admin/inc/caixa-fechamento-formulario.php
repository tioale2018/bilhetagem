...
<table class="table">
    <tbody>
            ...
            <td width="60%">
                <table class="table">
                    ...
                    <td><input type="text" name="fval_abrecaixa" class="form-control form-caixa money" value="<?= number_format($row_caixaformulario['val_abrecaixa'], 2, ',', '.'); ?>"></td>
                        <td>
                            <input type="text" name="fsaldo_anterior" class="form-control form-caixa money" value="<?= number_format($row_caixaformulario['sis_abrecaixa'], 2, ',', '.'); ?>" readonly>
                            (Saldo em <?= date('d/m/Y', strtotime($row_caixaformulario['sis_datasaldo'])) ?>)
                        </td>
        ...
        */ ?>
        ...
        <tr>
            <th>Sangria (Valor em espécie no caixa)</th>
                    ...
                    <tbody>
                        <tr>
                            <!-- <td>R$ <span><?= number_format($dinheiro, 2, ',', '.'); ?></span></td> -->
                             <td><input type="text" name="sis_cartao" class="form-control form-caixa money" value="<?= number_format($cartao, 2, ',', '.'); ?>" readonly></td>
                             <td><input type="text" name="sis_pix" class="form-control form-caixa money" value="<?= number_format($pix, 2, ',', '.'); ?>" readonly></td>
                        </tr>
                        <tr>
...
<input type="hidden" name="diario" value="<?= $diarioAtivo ?>">