                ...
                <ul class="h-menu">
                    ...
                    <li><a href="javascript:void(0)">Operacional</a>
                        <ul class="sub-menu">
                            ...
                            <li><a href="controle.php">Controle de Recreação</a></li>
                            <li><a href="entrada-nova.php">Nova entrada</a></li>
                            
                        </ul>
                    </li>
                    <!-- <li><a href="javascript:void(0)">Cadastro</a></li>
                    <li><a href="javascript:void(0)">Relatório</a></li> -->
                    <li><a href="troca-evento.php">Trocar evento</a></li>
                    <li><a href="caixa-basico.php">Livro Caixa</a></li>
                </ul>
            </div>
        </div>
    </div>
